...
- Pros/Cons
  collapsed:: true
	- Pros
		...
		- Generics
	- Cons
		- ((63209272-1088-4824-a762-4ac7ded04b0a)) isn't necessarily the best client
			- ((82b8c050-6bf4-4126-9908-c7885895c0da))
		...
		- Desktop applications created with Visual Studio don't work equally as well on Linux
			- Are there any GUI ((663a5789-27f9-434f-a095-5859a5cefbc1)) which are cross-platform?
...
- # Documentation
		  ...
		  collapsed:: true
			  ...
			  collapsed:: true
				- Notes
					- ## [Introduction](https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/)
						...
						- ### Types and variables
						  id:: 663a5789-a60b-44ca-9e8d-b4278f4fc1d8
						  collapsed:: true
			...
			- [C# reference](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/)
			  ...
			  Incomplete
				...
				- Types
					- [Value types](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/value-types)
					  id:: 66ba4cda-0cd9-4ee1-954d-2a896d467144
					- [Reference types](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/reference-types)
					  id:: 66ba4cde-bde5-401a-9380-77f915ce9bcf
					- [Built-in types](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/built-in-types)
					  id:: 66ba4cfc-7f40-4df7-9fe6-f6745cd8a015
					  collapsed:: true
					  ((66ba4cda-0cd9-4ee1-954d-2a896d467144)) + ((66ba4cde-bde5-401a-9380-77f915ce9bcf))
						- ## Built-in ((66ba4cda-0cd9-4ee1-954d-2a896d467144)):
						-
						- ## Built-in ((66ba4cde-bde5-401a-9380-77f915ce9bcf)):
							- | C# type keyword | .NET type |
							  ...
							  | [`dynamic`](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/reference-types#the-dynamic-type) | 
							   | [System.Object](https://learn.microsoft.com/en-us/dotnet/api/system.object) |
					- Related: ((663a5789-a60b-44ca-9e8d-b4278f4fc1d8))
				- Keywords
					- Modifiers
						- Access Modifiers
	...
	- ## Learning resources sorted by priority
	  id:: 64400aaf-af93-4739-a73b-97b213f053d6
				  ...
				  [Cheatsheet](https://www.codecademy.com/learn/learn-c-sharp/modules/csharp-hello-world/cheatsheet) / ![codecademy c# cheatsheet.pdf](../assets/codecademy_c#_cheatsheet_1704998904655_0.pdf)
					- ## Hello World
					  collapsed:: true
						...
						- Basic template
						  id:: 65a03829-8dc5-48ce-b514-8b3991218382
							- ```c#
							  using System;
							  ...
							  ```
							- Related: ((661ef01a-b762-48c2-9d34-e6f9f6729227))
						- `Console.WriteLine("Hello World!");`
						...
						- ### Making Classes
							...
							- Dot notation can be used to edit `fields` of a class instance
								- ```c#
								  ...
								  ```
						- ### Constructors
						  id:: 661c6c5f-b012-4d8a-8917-e7abd2b53cb5
					...
					- ## Static Members
					  ...
					  collapsed:: true
						...
						- ### Static Fields and Properties
							- Just add `static` after the ((661a564c-a48e-43aa-9020-e78570ea7649)):
								- ```c#
								  class Forest
								  {
								  ...
								  ```
						- ### Static Methods
							- Similarly for `static` methods just add it after the ((661a564c-a48e-43aa-9020-e78570ea7649))
								- ```c#
								  class Forest
								  {
								    private static string definition;
								  ...
								  ```
							- `static` methods can only access other `static` members, which is why in the above example we also make the referenced field `definition` into `static` too
						- ### Static Constructors
							- An instance constructor is run before an instance is used, and similarly a *static constructor* is run once before a class is used
							- This constructor is run when either one of these events occurs:
								- Before ((661cd304-a895-435d-a071-de17dee094da))
								- Before a `static` member is accessed.
							- Typically we use static constructors to set values to static fields and properties.
							- A static constructor does not accept an ((661a564c-a48e-43aa-9020-e78570ea7649)).
							- Basic syntax
								- ```c#
								  class Forest
								  {
						...
						- ### Common Static Errors
							...
							- This usually means you tried to reference a non-static member from a class, instead of from an instance:
								- ```
								  ...
								  ```
								- Make the ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)) `static` or change your calling to instead use a newly created instance instead of the class itself
							- This usually means that you tried to reference a static member from an instance, instead of from the class:
								- ```
								  ...
								  ```
						- ### `Main()`
						  id:: 661ef01a-b762-48c2-9d34-e6f9f6729227
							- Typical format
								- ```c#
								  class Program
								  {
								  ...
								  ```
									...
									- `string[] args` — The method has one parameter named `args`, which is an array of [strings](https://www.codecademy.com/resources/docs/c-sharp/strings).
							- Basic version
								- ```c#
								  class Program
								  {
							...
							- `dotnet run` with args
								- `dotnet run mango pineapple lychee` is equivalent to:
									- ```c#
									  Program.Main(new string[] {"mango", "pineapple", "lychee"});
									  ```
									- You're
							- Related: ((65a03829-8dc5-48ce-b514-8b3991218382))
					- Related: [[C#]] : ((661cd020-2e0e-4485-b230-0fc196788cac))
				- # ((661a4437-245d-4509-9269-cbfde10b1501)) and ((661a4437-0bc6-4f55-a472-7c22c80386ae))
					- ## Interfaces
					  collapsed:: true
						- ### Build an Interface
							- Sets of actions and values that describe how a class can be used e.g. do they have X property, Y method etc. This allows type-checking before runtime.
							- In C#, this group of interactions is called an *interface*. The interface is a set of properties, methods, and other members. They are declared with a signature but their behaviors are not defined. A class *implements* an interface if it defines those properties, methods, and other members.
						- ### Implementing an Interface
							- A type error will occur if the class we've created isn't implementing the appropriate interface
								- ```
								  error CS0535: Sedan does not implement interface member 'IAutomobile.LicensePlate'
								  ```
							- Class members must be `public` in order to be accessible by the interface
							- How to copy an interface to a MVP class:
								- At minimum when copying from an interface to creating the class members you'll need to ensure they're `public`, and give methods a curly bracket code block
						- ### What Interfaces Cannot Do
							- Interfaces specify the minimum amount of class members that a class must have - there could still for example be additional methods in the class that aren't in the interface
							- Interfaces cannot at all specify these class members:
								- ((661c6c5f-b012-4d8a-8917-e7abd2b53cb5))
								- ((661cd415-531d-4bf2-a4d9-707772648dca))
						- Multiple classes can use the same interface
					- ## Inheritance
					  collapsed:: true
						- ### Introduction to Inheritance
							- Duplicate code should be avoided because:
								- It's a waste of time
								- It's a risk factor for bugs
							- Inheritance is one solution to duplicate code ( ((662514b3-ea84-46b5-be53-acb90669db8b)) is another)
						- ### Superclass and Subclass
							- Superclass
							  id:: 662514fa-98d8-4f9e-9a80-ec0ae649dfa9
							  AKA base class
								- It's class members are inherited by another class
								- ((6625151d-9c17-440a-9624-4298a0203bb0))
							- Subclass
							  id:: 662514e7-0155-4b75-bf08-039b3ec57a35
							  AKA derived class
								- Inherits the members of another class
								- A class can only inherit from one ((662514fa-98d8-4f9e-9a80-ec0ae649dfa9))
								  id:: 6625151d-9c17-440a-9624-4298a0203bb0
						- ### Create a Superclass
							- Syntax
								- It's created like any other class
									- ```c#
									  class Vehicle
									  {
									  }
									  ```
								- A ((662514e7-0155-4b75-bf08-039b3ec57a35)) inherits a ((662514fa-98d8-4f9e-9a80-ec0ae649dfa9)) using colon syntax `:`
									- ```c#
									  class Sedan : Vehicle
									  {
									  }
						...
						- ### Access Inherited Members with Protected
							- Dealing with this error
								...
								- Instead use ((661c63bd-9124-4472-81bf-5093e741ae8e))
						...
						- ### Access Inherited Members with Base
							- We can refer to a superclass inside a subclass with the `base` keyword.
								- Example, in `Sedan` this refers to the `SpeedUp()` method in `Vehicle`
									- ```c#
									  base.SpeedUp();
									  ```
							- for calling the superclass constructor:
								- ```c#
								  ...
								  ```
									...
									- The `Sedan` constructor calls the `Vehicle` constructor with one argument, `speed`. This works as long as `Vehicle` has a constructor with one argument of type `double`.
								- Even if we don’t use `base()` in `Sedan`, it will call a `Vehicle` constructor. Without an explicit call to `base()`, any subclass constructor will implicitly call the default arameterless constructor for its superclass. For example, this code implicitly calls
								   `Vehicle()`:
									- ```c#
									  class Sedan : Vehicle
									  {
								...
								- You'll get this error if `base()` is used but a parameter is required:
									- ```
									  Sedan.cs(7,12): error CS7036: There is no argument given that corresponds to the required formal parameter 'speed' of 'Vehicle.Vehicle(double)
									  ```
						- ### Override Inherited Members
							- `override` and `virtual` modifiers can be used together to create a class that inherits from a ((662514fa-98d8-4f9e-9a80-ec0ae649dfa9)) but uses modified versions of some class members
							...
							- In the subclass, we mark the method as `override`, which tells the computer “I know this member is defined in the superclass, but I’d like to override it with this method”:
								- ```c#
								  ...
								  ```
							- **Alternate solution**
								- Instead of using `virtual` and `override` to override a member, [we can define a `new` member with the same name](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/classes-and-structs/knowing-when-to-use-override-and-new-keywords).
								- Essentially, the inherited member still exists, but it is “hidden” by the member in the subclass. If this sounds confusing, that’s okay! We also think it leads to unnecessary confusion, and that leads to errors.
						- ### Make Inherited Members Abstract
							- This is how we ensure a specific named class member is present on each subclass, but doesn't specify the implementation (e.g. how a method works can be different for each subclass)
							- Sounds similar to an interface, however this ensures it's available to all subclasses not just one
							- Syntax
								- On the superclass:
								  ```c#
								...
								- #+BEGIN_NOTE
								  No { } code block.
								  #+END_NOTE
								- This is like telling the subclasses: “If you inherit from me, you must define a `Describe()` method because I won’t be giving you any default functionality to inherit.”
								- In other words, abstract members have no implementation in the superclass, but they must be implemented in all subclasses.
							- If a class member is `abstract`, then the entire class must be `abstract` too
								- Superclass:
								  ```c#
								  abstract class Vehicle
								  ```
								- If one member of a class is abstract, then the class itself can’t really exist as an instance. Imagine calling `Vehicle.Describe()`. It doesn’t make sense because it doesn’t exist! The class must be `abstract` too
								- ```
								  error CS0513: 'Vehicle.Describe()' is abstract but it is contained in non-abstract class 'Vehicle'
								  ```
							- In each subclass then you'll need the relevant class member to be an `override`
								- e.g. in `Sedan`
								  ```c#
					...
					- ## Reference Fundamentals
					  collapsed:: true
						- ### References of the Same Type
							- ((661c63bd-dfef-42bc-896f-114bb592d4e3)) are ((661a4489-d8a6-4020-8146-0bffe7ff1d2b)) - this means when we create a new instance of it and store it in a variable, the variable is a *reference* to a place in memory.
							- This code creates two references to the same object - **not** two separate objects:
								- ```c#
								  Dissertation diss1 = new Dissertation();
								  Dissertation diss2 = diss1;
								  ```
						- ### References vs Values
							- In contrast there are also ((661a447e-7ac5-4ade-83d2-6afb498009dd)) which instead hold the actual data, instead of referencing a location in memory.
							- If you assign a variable to a ((661a447e-7ac5-4ade-83d2-6afb498009dd)) then it'll copy the value into that variable:
								- ```c#
								  bool falseValue = false;
								  bool anotherFalseValue = falseValue;
								  ```
						- ### Reference vs Value Comparison
							- Using ((661a4c49-2b9f-418a-a8fa-d6d078d5d5ef)) with two value types is a *value comparison*, which works like you might expect
							- Using ((661a4c49-2b9f-418a-a8fa-d6d078d5d5ef)) with two reference types is a *referential comparison*, which means it checks if the two variables reference the same memory location
								- ```c#
								  Book b1 = new Book();
								  Book b2 = b1;
						...
						- ### References of Different Types
							- We can reference an object by it's interface instead
								- ```c#
								  Dissertation diss = new Dissertation(50);
								  IFlippable fdiss = diss;
								  ```
								- #+BEGIN_WARNING
								  You can only use functionality on the interface if you reference it this way.
								  #+END_WARNING
									- ```c#
									  diss.Flip();
									  fdiss.Flip();
									  Console.WriteLine(diss.Define());
									  Console.WriteLine(fdiss.Define()); // error
									  ```
								- This allows us to modify many types at the same time e.g. all classes which have the `IVehicle` interface now have `X` property value
									- **Arrays of References**
										- We can create an array of references (using the interface they all share):
											- ```c#
											  IFlippable[] classroom = new IFlippable[] { new Diary(1), new Diary(30), new Dissertation(50), new Dissertation(49) };
											  ```
										- Then for example run a method they all share to modify them all simultaneously:
											- ```c#
										...
										- ### Another example
											- ```c#
											  ...
											  ```
						- ### Polymorphism
						  id:: 66256b64-7afd-4c3e-a022-da23147a6202
							- The ability to present the same interface for multiple, differing data types
								- Interface in the general meaning
							- A programming language supports polymorphism if both:
								- Objects of different types have a common interface (interface in the general meaning, not just a C# `interface`)
								  id:: 662591a2-41df-4e8c-a6dd-3ed31f5ef6ef
								- The objects can maintain functionality unique to their data type
								  id:: 662591a2-10d4-4d39-82b4-5cc01cf7c6c8
							- **Example**
								- `override` used so that ((662591a2-10d4-4d39-82b4-5cc01cf7c6c8))
								  ```c#
								  ...
								  ```
								- Can call the `Stringify()` method on both ( ((662591a2-41df-4e8c-a6dd-3ed31f5ef6ef)) )
								  ```c#
								  Book bk = new Book();
						...
						- ### Casting
							- Upcasting
							  id:: 6625931f-08e2-43d6-a9db-a097f2a812fa
								- Pros/Cons
									- Pros
										- If we're not sure what type a variable is, we know we can at least store it as the upcast type (e.g. ((65a07222-6203-47ea-a9b5-16c0a0ac189c)) )
										- If you only need access to ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)) of the upcasted type, it's fine to just reference the variable as that type
									- Cons
										- We lose all the specific type's functionality if it's referenced as an upcasted type (e.g. methods and other ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)) in the same class)
										- We lose the automatic type-checking that saves us from type errors
									- Unclear
									- Comparisons
								- is when you reference up the ((661a4437-0bc6-4f55-a472-7c22c80386ae)) hierarchy in order to manipulate multiple types at once
								- e.g. in the ((66256b64-7afd-4c3e-a022-da23147a6202)) example when you reference by using the ((662514fa-98d8-4f9e-9a80-ec0ae649dfa9)) or ((661a4437-245d-4509-9269-cbfde10b1501)) instead
								- Related: ((65a07222-6203-47ea-a9b5-16c0a0ac189c))
							- Downcasting
								- i.e. reference an object by it's ((662514e7-0155-4b75-bf08-039b3ec57a35)). Necessary when you want to access specific functionality of that subclass
								- It requires additional specific parentheses syntax (AKA explicit casting)
									- ```c#
									  Book bk = new Book();
									  Dissertation bdk = (Dissertation)bk;
									  ```
									- `System.InvalidCastException: Specified cast is not valid.` error will happen if it fails
									- ```c#
									  // class Amphibian : Animal
									  Amphibian amp = new Animal(); // error
									  Amphibian amp = (Amphibian) new Animal(); // correct
									  ```
							- More info: [Casting and type conversions - C# Programming Guide - C# | Microsoft Learn](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/types/casting-and-type-conversions)
						- ### Null and Unassigned References
						  id:: 66256b69-7a35-40a8-840b-69693f4de256
							- When instead of a reference to an object you instead refer to no object
							- Null
								- ```c#
								  Diary dy = null;
								  ```
								- #+BEGIN_WARNING
								  You can only compare a `null` reference if it's explicitly labelled `null`.
								  #+END_WARNING
									- ```c#
									  Diary dy = null;
							...
							- Unassigned
								- ```c#
								  Diary dy;
								  ```
								- Each element is an unassigned reference:
								  ```c#
								  Diary[] diaries = new Diary[5];
								  // diaries[1] is unassigned, diaries[2] is unassigned, etc.
								  ```
					- ## The `Object` Class
					  id:: 65a07222-6203-47ea-a9b5-16c0a0ac189c
					  collapsed:: true
						- ### Introduction
							- The highest level in ((661a4437-0bc6-4f55-a472-7c22c80386ae)) hierarchy, very topmost ((662514fa-98d8-4f9e-9a80-ec0ae649dfa9))
							- This means you can always use ((6625931f-08e2-43d6-a9db-a097f2a812fa)) to reference types as `Object`s
								- ```c#
								  ...
								  ```
						- ### The Object Type
							- C# implicitly makes classes inherit `Object`
								- ```c#
								  // This code
								  class Book
								  {}
								  ...
								  {}
								  ```
							- ((661a447e-7ac5-4ade-83d2-6afb498009dd)) and ((661a4437-6b1e-415e-a5c4-4f1f32571d9c)) also inherit from `Object`
								- ```c#
								  Object o5 = 21;
								  Object o6 = false;
								  Object o7 = "Hello you!";
								  ```
						- ### Object Members
							- Notable ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)) of `Object`:
								- `Equals(Object)`
								  id:: 6626c310-169e-441a-b701-e05ec7531a68
								  Returns `true` if the current instance and the argument are equal (using value equality for value types and referential equality for reference types)
								- `GetType()` — returns the type of the object
								- `ToString()`
								  id:: 6626c310-0e2b-4ee7-b0ff-31ddc1ff37c1
						...
						- ### Overriding Object Members
							- ((6626c310-169e-441a-b701-e05ec7531a68)) and ((6626c310-0e2b-4ee7-b0ff-31ddc1ff37c1)) are `virtual` methods, so they can be overridden:
								- ```c#
								  class Diary
								  {
						...
						- ### Object in Plain Sight
							- `Console.WriteLine()` under the hood uses `override` on `Object`'s `ToString()` method:
								- ```c#
								  // These two lines are the same
								  Console.WriteLine(b);
								  Console.WriteLine(b.ToString());
								  ```
							- When a non-string object is printed with `Console.WriteLine()`, its `ToString()` method is called.
								- ```c#
								  class Program
								  {
								    public static void Main() 
								    {
								      Book b = new Book();
								      Console.WriteLine(b); // "I'm a book!"
								    }
								  }
								  ...
								  ```
						- [Learning Resources]
							- [Object Class (System) | Microsoft Learn](https://docs.microsoft.com/en-us/dotnet/api/system.object#remarks)
							-
					- ## ((661a4437-6b1e-415e-a5c4-4f1f32571d9c)), The Exception
					  collapsed:: true
						- ### Introduction
							- ((661a4437-6b1e-415e-a5c4-4f1f32571d9c)) are technically ((661a4489-d8a6-4020-8146-0bffe7ff1d2b)) however it's a bit more complicated in practice
						- ### Strings Can Look Like Values
							- Technically its value is stored as a collection of `char` objects
							- Since it's a class, it's a ((661a4489-d8a6-4020-8146-0bffe7ff1d2b))
							- It's behaviour in some ways is like ((661a447e-7ac5-4ade-83d2-6afb498009dd)):
								- A `string` reference will always point to the original object, so “modifying” one reference to a `string` will not affect other references
									- ```c#
									  ...
									  ```
									- Why
										- Strings are immutable - so if modify a string it actually returns a new `string` object
								- Comparing ((661a4437-6b1e-415e-a5c4-4f1f32571d9c)) with ((661a4c49-2b9f-418a-a8fa-d6d078d5d5ef)) performs a value, not referential, comparison
									- Example
									  ```c#
									  string s = "hello";
									  string t = "hello";
						...
						- ### Strings can be Null or Empty or Unassigned
							- Like other reference types, `string` references allows for ((66256b69-7a35-40a8-840b-69693f4de256)). They can also have a third value: *empty*.
								- ```c#
								  // Unassigned
								  string s;
								  // Null
							...
							- We can check for null OR empty [strings](https://www.codecademy.com/resources/docs/c-sharp/strings) using the static `String` method `IsNullOrEmpty()`. It’s explained [in more detail in the documentation](https://docs.microsoft.com/en-us/dotnet/api/system.string.isnullorempty).
								- ```c#
								  ...
								  ```
						- ### Strings as Class
							- Because strings are immutable, if you execute a method on a string you'll need to store it in a variable
								- ```c#
								  string lyrics = 
								  ...
								  ```
						- [Learning Resources]
							- [String Class (System) | Microsoft Learn](https://docs.microsoft.com/en-us/dotnet/api/system.string)
							-
				- # Lists and LINQ
					- ## Lists
					  id:: 65a07245-b931-4110-b435-0beebd495a48
					  collapsed:: true
						- Pros/Cons
							- Pros
								-
							...
							- Unclear
							- Comparisons
								- ((65a07245-b931-4110-b435-0beebd495a48)) vs ((661a4437-86cf-49d0-b482-e5613fa5ea99))
								  id:: ee4449c6-aae7-49bc-9d17-0294d554d043
									- For ((65a07245-b931-4110-b435-0beebd495a48))
										- Unlimited length (rather than limited)
										- Automatically tracks the number of actual elements in the list (rather than requiring a separate index)
										- Methods exist for manipulating multiple elements at once, rather than manipulating each element one-at-a-time
									- For ((661a4437-86cf-49d0-b482-e5613fa5ea99))
										-
									- Similarities
										-
									- Unclear
		  ...
		  collapsed:: true
			- [Arrays](https://www.codecademy.com/resources/docs/c-sharp/arrays)
			  ...
			  collapsed:: true
				- Pros/Cons
					...
					- Unclear
					- Comparisons
						- ((ee4449c6-aae7-49bc-9d17-0294d554d043))
				...
				- Related: ((65a07245-b931-4110-b435-0beebd495a48))
			- [Classes](https://www.codecademy.com/resources/docs/c-sharp/classes)
			  ...
			  collapsed:: true
				...
				- ## Making a Class Instance
				  id:: 661cd304-a895-435d-a071-de17dee094da
				  AKA Instantiation / making an object from the type
					- ```c#
					  ...
					  Methods are functions defined within the class that perform actions or operations. They can modify the class’s state or provide functionality. Another type of ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)).
						- ### Examples
							- ```c#
							  ...
							  ```
				- ## Access Modifiers
				  id:: 661a564c-a48e-43aa-9020-e78570ea7649
					- C# provides access modifiers to control the visibility and accessibility of class members. Common access modifiers include:
						...
						- `protected`
						  id:: 661c63bd-9124-4472-81bf-5093e741ae8e
						  Members are accessible within the class and any ((662514e7-0155-4b75-bf08-039b3ec57a35)).
							- i.e. subclasses can access it also
						- `internal`: Members are accessible within the same assembly (a group of related classes in the same project).
						- `protected internal`: Members are accessible within the same assembly and any ((662514e7-0155-4b75-bf08-039b3ec57a35)).
						- `private protected`: Members are accessible only from the ((662514e7-0155-4b75-bf08-039b3ec57a35))es within the current assembly. This access modifier has been available since C# 7.2 and later.
					- **Defaults:**
				...
				- ## Static Classes
				  id:: 661a564c-fa79-476f-9988-643fbc77ebf3
					...
					- Unlike regular classes, static classes cannot be instantiated with the `new` keyword. Instead, their members are accessed using the class name itself. These classes are commonly used for utility functions (e.g. `Math`, `Console`) or to group related functionality.
					- Example
						- Calling `Math` or `Console` static classes
						  ```c#
						  Math.Min(34, 54);
					...
					- **Fields**
					  ...
					  A type of ((661cd3ff-3d1f-4951-ae7f-a3d3dace497c)), refers to non-methods e.g. `string` variables(?)
						...
						- ```c#
						  ...
						  ```
				- Related: ((65a037a9-8b1c-41be-b6f0-1ff1aa61a4ed))
			...
			- [Data Types](https://www.codecademy.com/resources/docs/c-sharp/data-types)
			  ...
			  collapsed:: true
				...
				- ## Value Types
				  id:: 661a447e-7ac5-4ade-83d2-6afb498009dd
				  AKA primitive
			...
			- [Inheritance](https://www.codecademy.com/resources/docs/c-sharp/inheritance)
			  id:: 661a4437-0bc6-4f55-a472-7c22c80386ae
			  collapsed:: true
				...
				- ## Types of Inheritance
					...
					- ### Hierarchical Inheritance
						...
						- ```c#
						  ...
						  ```
				- ## Access Modifiers
					- See ((661a564c-a48e-43aa-9020-e78570ea7649))
			...
			- [Interfaces](https://www.codecademy.com/resources/docs/c-sharp/interfaces)
			  id:: 661a4437-245d-4509-9269-cbfde10b1501
			  collapsed:: true
				...
				- ## Syntax
					- An interface in C# is created using the `interface` keyword. The syntax for defining an interface in C# is:
						- Skeleton
						  ...
						  ```
						- Basic example with a method, property and event
						  ```c#
						  ...
						  ```
						- Convention is to name an interface starting with "I"
				...
				- ## Comparison Operators
				  id:: 661a4c49-5af5-4cc4-b1b0-2339ab8fa2b1
					- C# has the following comparison operators:
						- Equality `==`
						  id:: 661a4c49-2b9f-418a-a8fa-d6d078d5d5ef
						  For returning `true` if two values are equal.
						- Inequality `!=`
						  AKA Not equal | For returning `true` if two values are not equal.
						- Less than `<`
			  ...
			  collapsed:: true
				...
				- ## Methods
				  id:: 661ae9a6-dd5b-4411-90ec-48f6c5aa545f
					...
					- `.Length`
					  id:: 67376774-4af5-438d-81ff-f2e0383665c1
					  collapsed:: true
		...
		- [Learn C# - Free Interactive C# Tutorial](https://learncs.org)
	...
	- ## Assorted topics
		...
		- Arrays
		  collapsed:: true
			- ![image.png](../assets/image_1748204849665_0.png)
- # Ecosystem
	- Editors
	...
	- Other .NET application languages
		...
		- F#
	- Frameworks
	  id:: 663a5789-27f9-434f-a095-5859a5cefbc1
		- [ASP.NET](https://www.asp.net/)
		  id:: 6529189e-d194-44fe-8d48-13348d318139
		  collapsed:: true
			- ASP.NET is a web development framework developed by Microsoft for building dynamic web applications and services. It enables developers to create powerful web applications using languages such as C# or Visual Basic. ASP.NET allows for the creation of websites, web services, and web applications, providing developers with tools and libraries for tasks like database access, session management, and user authentication.
				- ASP.NET offers several key features:
					- **Server-side scripting**: ASP.NET allows developers to embed server-side code directly into their web pages, enabling dynamic content generation.
					- **Web Forms**: ASP.NET Web Forms is a feature that simplifies the process of building dynamic web pages by providing a set of server controls that abstract HTML elements and allow for event-driven programming.
					- **Model-View-Controller (MVC)**: ASP.NET MVC is a design pattern that separates an application into three main components: the model (data), the view (user interface), and the controller (logic). This approach provides better separation of concerns and supports test-driven development.
					- **ASP.NET Core**: This is the latest version of ASP.NET, which is a cross-platform, high-performance framework for building modern, cloud-based, and internet-connected applications. ASP.NET Core is open-source and can run on Windows, macOS, and Linux.
					- **Integration with Visual Studio**: ASP.NET integrates seamlessly with Microsoft's Visual Studio development environment, providing developers with a rich set of tools for building, debugging, and deploying web applications.
				- Overall, ASP.NET is a powerful framework for building robust and scalable web applications and services, and it's widely used in enterprise environments due to its reliability, performance, and integration with other Microsoft technologies.
			- [I use ASP.NET](https://news.ycombinator.com/item?id=33987796) (which produces an OpenAPI specification) + Entity Framework on the server, React + TypeScript on the client (which consume that specification through [openapi-generator](https://github.com/OpenAPITools/openapi-generator))
			  id:: 6638f8a8-e6fe-4920-b157-2db5e1af90ee
		- [.NET](https://learn.microsoft.com/en-us/dotnet/)
		  ...
		  AKA dotnet
			- Pros/Cons
			  ...
			  collapsed:: true
				- Pros
					- [Unless you found yourself in some bizarre dark corner of a huge ecosystem of pro... | Hacker News](https://news.ycombinator.com/item?id=44382601)
					-
				- Cons
						...
						- https://isdotnetopen.com/
							- problems:
								- [ramming in a proprietary extension to continue to lockdown .NET.](https://github.com/omnisharp/omnisharp-vscode/issues/5276)
									...
									- C# Dev Kit
										- [Announcing C# Dev Kit](https://devblogs.microsoft.com/visualstudio/announcing-csharp-dev-kit-for-visual-studio-code/) for ((63209272-1088-4824-a762-4ac7ded04b0a))
